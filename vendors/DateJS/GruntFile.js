...
module.exports = function(grunt) {
	...
	grunt.initConfig({
		...
		build_prod: {
			description: "Builds employee ready files (minified)"
		},
		closurecompiler: {
			minify: {
	...
	grunt.registerMultiTask("build_prod", "Rebuilds dev and minifies files for employee enviroments", function() {
